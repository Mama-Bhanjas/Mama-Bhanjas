...
export default function Login() {
    ...
    return (
        <div className="min-h-screen bg-surface-950 flex flex-col justify-center py-12 sm:px-6 lg:px-8">
            <Head>
                <title>Login - Mama-Bhanjas</title>
            </Head>
            ...
            >
                ...
                <p className="mt-2 text-center text-sm text-surface-400">
                    Community Authenticated Intelligence Platform
                </p>
            </motion.div>
                ...
                <div className="bg-surface-900/50 backdrop-blur-xl py-8 px-4 shadow-2xl border border-surface-800 sm:rounded-3xl sm:px-10">
                        ...
                        <div className="flex items-center justify-between">
                            <div className="flex items-center">
                                <input
                                    ...
                                    name="remember-me"
                                    type="checkbox"
                                    className="h-4 w-4 text-primary-600 focus:ring-primary-500 border-surface-800 rounded bg-surface-950"
                                />
                                <label htmlFor="remember-me" className="ml-2 block text-sm text-surface-400">
                                    Remember me
                                </label>
                            </div>
                    ...
                    <div className="mt-6">
                        ...
                        <div className="mt-6">
                            <Link
                                href="/register"
                                className="w-full flex justify-center py-3 px-4 border border-surface-800 rounded-xl text-sm font-bold text-surface-300 bg-surface-950 hover:bg-surface-800 transition-all"
                            >
                                Create Account
                            </Link>
                        </div>
