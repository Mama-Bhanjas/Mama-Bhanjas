...
export default function ReportForm() {
    ...
    const handleSubmit = async (e) => {
        ...
        if (!isAuthenticated) {
            setSubmitStatus({ type: 'error', message: 'Please login first to submit a report' });
            return;
        }
        ...
        try {
            // Submit metadata and file to backend using FormData
            ...
            setSubmitStatus({
                type: 'success',
                message: '✅ Report submitted successfully! Our community will verify it shortly.'
            });
